...
1. Research the repository:
   ...
   - Look for any issue_template.md, ISSUE_TEMPLATE.md, or similar files that might contain guidelines for creating issues.
...
3. Present a plan:
   ...
   - This should incluye all major intervention in the code. Or new files, or pieces of code
